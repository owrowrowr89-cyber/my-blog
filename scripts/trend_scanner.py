...
class TrendScanner:
    ...
    # 모니터링 대상 기업 + 카테고리
    WATCH_TARGETS = {
        "애플": ["아이폰", "맥북", "에어팟", "아이패드", "애플워치", "비전프로"],
        "삼성": ["갤럭시", "갤럭시북", "버즈", "QLED", "비스포크"],
        "엔비디아": ["지포스", "RTX", "AI 칩", "그래픽카드"],
        "테슬라": ["테슬라", "전기차", "모델Y", "사이버트럭"],
        "현대기아": ["현대차", "기아", "아이오닉", "EV9", "전기차"],
        "메타": ["메타", "오큘러스", "퀘스트"],
        "AI": ["AI", "챗봇", "생성형 AI", "LLM", "AI 비서"],
        "뷰티": ["미용기기", "뷰티테크", "피부관리기", "헤어드라이어"],
        "패션": ["스마트링", "스마트워치", "웨어러블"],
    }
